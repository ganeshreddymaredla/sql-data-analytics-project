...
===============================================================================
Purpose:
    - Compare each product's yearly sales against its own average and prior year.
    - Identify growth, decline, and benchmark performance.

SQL Used:
    - LAG()         — access previous year's sales
    - AVG() OVER()  — compute per-product average across all years
    - CASE          — classify trend direction
===============================================================================
*/
...
SELECT
    ...
    -- Compare to product's own historical average
